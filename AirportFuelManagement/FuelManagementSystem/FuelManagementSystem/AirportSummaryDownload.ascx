...
<div>
    <asp:ImageButton runat="server" ID="summaryReportImageButton" ClientIDMode="Static"  ToolTip="Download Summary Report" 
    ImageUrl="./Content/download-Logo.png"  OnClick="summaryReportImageButton_Click"/> 
</div>
<div>
    <asp:ImageButton runat="server" ID="fuelReportImageButton" ClientIDMode="Static"  ToolTip="Download Fuel Report" 
