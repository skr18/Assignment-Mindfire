...
namespace FuelManagementSystem.utils
{
    public class LogRecords
    {
        public static void LogRecord(Exception ex, string logPath)
        {
            ...
            {
                File.AppendAllText(pathName, DateTime.Now.ToString() + Environment.NewLine + exp + Environment.NewLine + Environment.NewLine );
            }
            else
            {
                File.WriteAllText(pathName, DateTime.Now.ToString() + Environment.NewLine + exp + Environment.NewLine);
            }
        }
